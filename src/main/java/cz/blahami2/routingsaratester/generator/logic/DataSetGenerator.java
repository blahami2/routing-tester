...
public interface DataSetGenerator {
     ...
     * @param metric      routing metric
     * @param graph       graph to search on
     * @param debugViewer debug viewer
     * @return dataset
     */
    <N extends Node<N, E>, E extends Edge<N, E>> List<DataSetElement<N, E>> generateDataSet( int size, int granularity, Metric metric, Graph<N, E> graph, DebugViewer debugViewer );
}
